"""
  ...
  Notes:
  This is the other half of the v3 pair, this script is designed to listen continuously for messages left in "task_queue3".
  It will continuously transmit these tasks to each of the workers.
  Once finished with listening remember to use Ctrl + C to close the listeners.
  
  Follow instructions in README to prepare multiple terminals and enviroment.
  If using Anaconda, always use Ctrl + C to close these terminals properly.
